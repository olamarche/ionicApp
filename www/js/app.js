angular.module('todo', ['ionic','firebase'])
    ...
    .factory('Projects', function() {
      ...
      .controller('TodoCtrl', function($scope, $firebase, $timeout, Modal, Projects) {
            ...
            $scope.projectsList = $firebase(new Firebase("https://ionicapp.firebaseIO.com/projects"));
            $scope.user = $firebase(new Firebase("https://ionicapp.firebaseIO.com/Users/John"));
